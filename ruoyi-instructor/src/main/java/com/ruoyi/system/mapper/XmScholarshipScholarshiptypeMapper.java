 ...
 * @date 2023-03-03
 */
public interface XmScholarshipScholarshiptypeMapper 
{
    /**
     * 查询奖学金与奖学金类型关联
     * 
    ...
    int batchinsert(ArrayList<XmScholarshipScholarshiptype> list);
    int deleteXmScholarshipScholarshiptypeByScholarshipId(Long scholarshipId);
}
